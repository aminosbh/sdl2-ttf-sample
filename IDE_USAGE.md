...
*Open the project:*<br>
Run Code::Blocks, and open the project in `sdl2-ttf-sample/build/codeblocks`.<br>
Finally, build and run the project.
...
cd sdl2-ttf-sample
mkdir ../eclipse-sdl2-ttf-sample
cd ../eclipse-sdl2-ttf-sample

# Generate an Eclipse project
cmake ../sdl2-ttf-sample -G "Eclipse CDT4 - Unix Makefiles"
```
*Open the project:*<br>
Run Eclipse, and open the project in `eclipse-sdl2-ttf-sample`.<br>
